...
@interface SWCTitleCell : PSTableCell <PreferencesTableCustomView> {
    UIView *bgView;
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(id)reuseIdentifier specifier:(id)specifier {
    ...
    packageNameLabel.text = @"SongShare";
...
-(void)layoutSubviews{
    ...
    UIColor *topColor = UIColorFromRGB(0x3498db);
    UIColor *bottomColor = UIColorFromRGB(0x2980b9);
